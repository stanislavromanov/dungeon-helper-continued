...
Dungeon Helper Continued automates the small courtesies and bookkeeping that come with running dungeons through the Dungeon Finder and Raid Finder. It greets your party when you zone in, tracks how long the dungeon takes, and offers a quick-leave option when the final boss is down, so you can focus on playing instead of typing.

## Features

**Auto-Greeting** - When you enter an instance through the Dungeon Finder or Raid Finder, the addon automatically sends a greeting message to instance chat. No more forgetting to say hi. The default message is "hi", but you can change it to anything you like.
...
The addon only activates in queued content (Dungeon Finder and Raid Finder). It does not trigger in Mythic+, premade groups, battlegrounds, or arenas.

## Lightweight and Non-Intrusive

- No external dependencies
- Minimal memory footprint
- Only activates in queued instances (LFG/LFR), never in the open world
